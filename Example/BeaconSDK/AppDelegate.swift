...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    fileprivate let receiver = BeaconReceiver()
...
extension AppDelegate: BeaconReceiverDelegate {
    ...
    func receiver(_ receiver: BeaconReceiver, parsedString string: String) {
        postNotification(beaconStringNotification, value: string)
    }
    
    func receiver(_ receiver: BeaconReceiver, parsedGGA gga: GGA) {
        postNotification(beaconGGANotification, value: gga)
    }
    
    func receiver(_ receiver: BeaconReceiver, parsedVTG vtg: VTG) {
        postNotification(beaconVTGNotification, value: vtg)
    }
    
    func receiver(_ receiver: BeaconReceiver, parsedGSV gsv: GSV) {
